...
public class EmailService {
    ...
    public void sendVerifyToken(String to, String token, Long id) throws MessagingException {
        try {
            String verifyLink = "http://localhost:8080/web/v1/auth/verifyaccount?token=" + token +"&id=" + id;
    ...
    public void sendResetPasswordToken(String to, String token, Long id) throws MessagingException {
        try {
            String verifyLink = "http://localhost:8080/web/v1/auth/forgetpassword/verify?token=" + token +"&id=" + id;
